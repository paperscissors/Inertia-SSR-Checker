#!/usr/bin/env python
"""
Test script to generate a sample report using the simplified HTML template
"""
import os
...
def generate_test_report():
    output_path = Path("test_simple_report.html")
    generate_simple_html_report(sample_issues, output_path)
